...
// page: renders the 3 concepts, posts an upvote to /share/<token>/vote, and reflects
  ...
  return (
    <div>
      {leader ? (
        ...
        >
          Crew favorite so far: <span className="font-semibold text-zinc-900">{leader.title}</span>{' '}
          · {total} {total === 1 ? 'vote' : 'votes'}
        </p>
      ) : (
        <p className="mb-6 text-center text-sm text-zinc-500">Be the first to vote.</p>
      )}
          ...
          return (
            <li
              ...
              className={
                ...
                (isVoted ? 'border-brand ring-1 ring-brand' : 'border-zinc-200')
              }
            >
              ...
              <div className="flex flex-1 flex-col gap-2 p-4">
                ...
                <button
                  ...
                  className={
                    'mt-auto inline-flex h-9 items-center justify-center gap-2 rounded-md px-3 text-sm font-medium transition-colors disabled:opacity-60 ' +
                    (isVoted
