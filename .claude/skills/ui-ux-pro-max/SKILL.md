...
- Style library notes: glassmorphism now reads as "iOS 26 Liquid Glass adjacent" — use with platform intent or skip; M3 Expressive legitimizes bolder shape/color play on Android-flavored products.
- Default a11y acceptance in every build: 24×24 targets, visible focus (not obscured), prefers-reduced-motion honored on all scroll-driven/View-Transition effects.
